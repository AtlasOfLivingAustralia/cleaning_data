...
This section describes how to clean and correct a dataset, we've divided this into three main sections: taxonomy, distribution, and ecology.

In @sec-taxonomy

The following steps assume that the taxonomic history of the included species are known, correct, and out-of-date names and synonymy have been fixed during the data preparation.

**Standarize scientific names**

Ensure that the spelling is correct and fix errors as they appear. It is essential to decide how to want to record the scientific names and be consistent with formatting. For example, it can always start with upper case and separate the names with an underscore, as in "Moloch_horridus". It is also important to check if higher taxonomic classification hierarchy is correct and not missing, such as family and order.
...
These steps might be applicable depending on the research aim.
