...
Dates can be formatted across data in *a lot* of different ways. Here are just a few
examples:
...
the [R for Data Science book](https://r4ds.hadley.nz/datetimes.html) is a great resource.[^r-for-data-science-1]

[^r-for-data-science-1]: Wickham, H., Çetinkaya-Rundel, M., & Grolemund, G. (2023). R for Data Science: Import, Tidy, Transform, Visualize, and Model Data. O’Reilly.
...
In the next chapter, we look at issues more specific to ecological data. The first will be working with **taxonomy**, or species names and splits.
