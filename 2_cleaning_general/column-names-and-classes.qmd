...
doi_frogs <- "https://doi.org/10.26197/ala.5570ae7f-5beb-4640-9227-2a681029f804"
```
...
doi_table <- open_dataset(here::here("data-raw", "doi_table")) |>
...
#### Original galah query

**Note:** You don't need to run this code block to read this chapter. 

This code chunk will download the latest data from the ALA, which might not reproduce the *exact* results in this chapter (but will be very close anyway).
...
frogs <- galah_call() |>
  ...
  atlas_occurrences() # <1>
```
1. To create a DOI for your download, use `atlas_occurrences(mint_doi = TRUE)`
...
On the other hand, people might wonder why the output looks differen? I'm not sure.
- DK
-->
