...
If you are using a `tibble`, the class is also displayed below each column name when you view your table (here there are two classes: character `<chr>`, double `<dbl>` and date-time `<dttm>`). 
