...
<!-- I've incorporated the tip into the summary at the end of the chapter because I found it confusing to read before going into the methods we discuss in the chapter -->
...
Let's remove spatially-duplicated records, based on latitude and longitude coordinate values. 
...
Splitting by species has reduced the total number of duplicate records by ~3,500 rows because multiple species could have records with the same spatial coordinates. 
