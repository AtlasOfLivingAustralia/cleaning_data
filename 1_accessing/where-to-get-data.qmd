...
queries. One benefit of using `galah` is that it uses tidy syntax (much like the
tidyverse) to download data. Additionally, galah can access data from 10 other
