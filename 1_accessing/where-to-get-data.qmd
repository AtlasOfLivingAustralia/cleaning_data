...
<!-- We need a smaller solution to the below code. But ideally, we'll have an example of a raster over Australia -->
...
#| message: false
# Load data from file:
worldclim <- terra::rast(here::here("data",
                                    "rasters",
                                    "bioclim-aus.tif"))
worldclim
```
...
We discuss these considerations in more detail in \[Chapter xxx taxonomy expert
cleaning\].
...
occurrence data from a variety of sources, including GBIF,
[VertNet](https://github.com/ropensci/rvertnet) and
