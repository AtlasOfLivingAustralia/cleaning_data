...
chapter](../2_cleaning_general/missing-values.qmd), many spatial
...
**Dax's note: I don't think this is a very good example, but I'm not
sure whether there are any examples of this on the ALA. Not sure if this
should be included at all then, if that's the case.**
...
the [start of the chapter](LINK)), these locations can appear suspicious
...
the coordinates happen to overlap with one of the points.
