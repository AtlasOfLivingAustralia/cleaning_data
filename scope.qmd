...
Data scope refers to the type and breadth of data needed for your project. [Defining your scope let's you...*good things*]. [Without defining your data scope, you might not answer the question you set out to answer.]
<!-- some suggestions in brackets. This will probably be the level of detail that you need.  -->
...
<!-- I see what you are getting at with the above note, but I don't know that increasing the scope of your data is the write suggestion. It's mostly just a consequence of less data, rather than a solution, that you might have to rethink your question when there is less data. If you want to study a rare species, it's not useful to be so broad about your question to not learn anything new about the rare species of interest. Maybe try rewriting to not suggest what to do about this problem, but just make people aware that this can happen  -->
