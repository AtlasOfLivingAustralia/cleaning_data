...
The content of this book is guided by the current state of biodiversity literature on preparing data for species distribution modelling. For more details about how this was done, please refer to the [Appendix](@sec-appendix). All resources that have been consulted for this book can be found in [References](@sec-references).
...
We welcome contributions to this document and suggest folks to submit pull requests at the [GitHub repository](https://github.com/AtlasOfLivingAustralia/cleaning_data) where this document lives. Contributing guidelines can be found at XX (Maybe another section or just a MD in GitHub Repo)
