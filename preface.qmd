...
Ecological and biological data are complex, and so data cleaning can be
a daunting task. People who work with ecological or biological data want
to know how to clean their data effectively. At the [Atlas of Living
...
To find out, we undertook an small, informal literature review on
ecological data cleaning using both peer-reviewed and grey literature.
...
We selected a collection of papers that matched these themes. We tried
to choose recently published papers that used up-to-date workflows with
...
common, best-practice steps—and any common sequences these steps are
made in—we read through their methods sections and collated their data
