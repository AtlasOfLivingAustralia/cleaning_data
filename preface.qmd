...
To find out, we undertook an small, informal literature review on ecological
data cleaning using both peer-reviewed and grey literature. The key themes we searched for were:
...
We selected a collection of papers that matched these themes. We tried to
choose recently published papers that used 
up-to-date workflows with recent packages and tools in R. We also added
several frequently referenced papers for comprehensiveness, and we reviewed data cleaning workflows from our
project partners [@marsh2021; @godfree_implications_2021] to
understand their processes, issues and needs.

From our informal search, we ended up with a list of 18 papers
and resources (listed [here](LINK)) with relevant ecological data
cleaning workflows. To determine any common, best-practice steps—and any common sequences these steps are made in—we read through their methods sections and
...
doesn't seem to be many resources that consolidate methods to clean
