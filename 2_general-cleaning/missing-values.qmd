...
<img class = "rounded" src="https://images-assets.ala.org.au/store/8/7/9/8/89ad2446-e89c-481c-97d7-375ffad18978/thumbnail_large"></img>
...
<img class = "rounded" src="https://images-assets.ala.org.au/store/2/0/b/0/44f6694a-024a-45cd-896a-b73538fc0b02/thumbnail_large"></img>
...
[^3]: Because both `geckos_missing` and `list_subset` already have `class` and `family` columns, we've specified a suffix to append to our new column and our old column after joining `geckos_missing` and `list_subset` together using the argument `suffix` in `left_join()`.
...
<img class = "rounded" src="https://images-assets.ala.org.au/store/c/d/a/d/817ae616-5596-407d-bab3-259ad78adadc/thumbnail_large"></img>
