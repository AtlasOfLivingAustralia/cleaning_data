...
If your project relates to data from a specific data provider, it might be best to download data directly from the source. For example, a common source of citizen science species observation data is [iNaturalist](https://www.inaturalist.org/). Downloading directly from the data provider may ensure you don't have any stray data from other sources.
