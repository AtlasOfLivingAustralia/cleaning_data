...
If you download the data's DOI, all examples in this book using that dataset shoule be reproducible. Data DOIs preserve the exact dataset, so downloading data using the DOI should allow you to match the output of the examples over this book. DOIs are regenerated each time the book is re-rendered. 
