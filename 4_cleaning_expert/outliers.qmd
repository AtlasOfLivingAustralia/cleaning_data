...
*Dax's Note:*
I think this section could show how outliers need to be checked, rather than removed because they appear in an unexpected place or aren't identified to a lower taxonomic level. Showing an example with a map of some points that look like outliers but are correct (verified by an image), or a taxonomic clade where the same species falls into several different subspecies could be useful.

This section doesn't need to be long. We could follow Andrew's lead that we suggest references too.
