...
<!-- This chapter contains a lot of examples that once fit in the book but maybe don't anymore. Figured they might be recycled as ideas or content later. -->


<!--
This section used to follow "A first glimpse" in the Inspect chapter
On second thought, it seems redundant - many other chapters handle more detailed evaluation, so we might as well delete -DK
-->
...
<!--
These are other examples that could have been in the Geospatial cleaning chapter but I couldn't find examples for. -DK
-->
...
A risk of using data of many types is that sometimes, if observations
and specimen data are mixed, some coordinates will specify the location
of the specimen, not the observation. These records must be excluded if
you are interested in analysing occurrence locations.
