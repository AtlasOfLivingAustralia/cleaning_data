...
unexpected location, whereby swapping the latitude and longitude will place 
the coordinates where they are expected.
...
can make finding possible spatial outliers faster.
