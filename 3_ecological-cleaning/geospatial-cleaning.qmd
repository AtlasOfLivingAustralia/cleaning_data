...
methods. It is crucial to clean geospatial data effectively to ensure their
...
<!-- Maybe we should link to section 5.2.1 specifically, since that's the part of the chapter that discusses missing data and spatial analyses? -SB -->
...
<!-- I think this header could be more informative, but I can't think of any alternatives. I don't think I understand what the header means -SB -->

<!-- Update: possible header options are "Correcting Fixable Coordinate Errors" and "Excluding Unfixable Coordinate Errors". Also see comments in slack about turning this into 1 example instead of 2 -SB -->
...
and corrected. Follow the link to each case study to learn how to identify and
fix the issue.

<!-- Where are the abovementioned case studies? -SB -->
...
We can correct the numeric signs using `case_when()` from dplyr, which
...
<!-- I personally find if_else() statements much easier to read when there are only two options. I don't feel strongly about changing this but I'm curious to know if there are any other benefits to using case_when(). -SB -->
...
<!-- I don't understand why flipped coords would appear as a cluster of points. It's also unclear why we're citing this paper here - it's a great overview of a lot of geographical data cleaning, so perhaps it was supposed to go in the intro to this section? - SB -->
...
<!-- Maybe remove this section if we don't have anything for now? Looks like a draft otherwise -SB -->
...
<!-- I don't understand why this is here, and I don't know what I'm supposed to takeaway from this. I think we should either remove or expand on what's being demonstrated here -SB-->
