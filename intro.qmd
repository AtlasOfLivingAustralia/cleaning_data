...
-   [Register an account with Atlas of Living Australia](https://auth.ala.org.au/userdetails/registration/createAccount)
-   [Register an account with Global Biodiversity Information Facility](https://www.gbif.org/user/profile)
...
Other excellent IDEs like [Visual Studio Code](https://code.visualstudio.com/) 
can be good alternative options depending on your preferences.
...
A list of the most common packages in this book can be found on the [Packages page](4_appendices/packages.html).
...
You can copy code by clicking the {{< fa clipboard title="clipboard">}} button in the top right corner of a code block.
:::
