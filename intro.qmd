...
Although the principles we cover to clean data apply to many types 
...
1.  This line of code groups `penguins` data by each distinct value in the
    variable `species`
2.  This line of code summarises each species' mean bill length, saving the output in a new column `mean_bill_length`
