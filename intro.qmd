...
Sign up with the relevant data infrastructure e.g GBIF or ALA

For example for ALA, data can be accessed via the R package {galah} and users must configure their XX prior to download.
