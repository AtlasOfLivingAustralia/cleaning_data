...
::: {style="display: flex; flex-wrap: wrap; justify-content: flex-end; margin-left: 20px;"}
...
[**Download data**]{style="color: #efa123; text-align: center;"}
:::

::: {style="width: 25%; text-align: center;"}
<div style="border-radius: 50%; overflow: hidden; display: flex; align-items: center; justify-content: center; background-color: #ddd; padding: 40px; width: 120px; height: 120px;">
  {{< fa table style="font-size: 3em;" >}}
</div>
:::

::: {style="width: 25%; text-align: center;"}
<div style="border-radius: 50%; overflow: hidden; display: flex; align-items: center; justify-content: center; background-color: #ddd; padding: 40px; width: 120px; height: 120px;">
  {{< fa thumbs-up style="font-size: 3em;" >}}
</div>
:::
